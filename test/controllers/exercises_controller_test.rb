...
class ExercisesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create exercise" do
    assert_difference("Exercise.count") do
      post exercises_url, params: { exercise: { block_id: @exercise.block_id, description: @exercise.description } }
    end
  ...
  test "should update exercise" do
    patch exercise_url(@exercise), params: { exercise: { block_id: @exercise.block_id, description: @exercise.description } }
